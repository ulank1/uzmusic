...
import uz.audio.helpers.FileNameReformatter;
...
public class SearchResultsAdapter extends RecyclerView.Adapter<SearchResultsAdapter.SearchItemCardViewHolder>{
    ...
    public void onBindViewHolder(final SearchItemCardViewHolder holder, int position) {
        ...
        if (!dbHelper.isFavorite(model.Video_id)){
            holder.favorite.setImageResource(R.drawable.ic_favorite_none_active);
        }else {
    ...
    public static class SearchItemCardViewHolder extends RecyclerView.ViewHolder{
        ...
        public SearchItemCardViewHolder(View itemView) {
            ...
            favorite = (ImageView) itemView.findViewById(R.id.btn_favorites);
            ...
            favorite.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ItemModel itemModel = SearchResultsAdapter.getInstance(context).itemModels.get(pos);
                    DbHelper dbHelper = DbHelper.getInstance(context);

                    if (dbHelper.isFavorite(itemModel.Video_id)){
                        dbHelper.deleteFavorite(itemModel.Video_id);
                        favorite.setImageResource(R.drawable.ic_favorite_none_active);
                    }else {
                        dbHelper.addFavorite(itemModel);
            ...
            infoWrapper.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                   ...
                   // PlaylistGenerator.getInstance(context).preparePlaylist(v_id);
                    Shared.playlistItems = Shared.playlistItemsDontPrepared;
                    Shared.position = getAdapterPosition();
