...
public class MediaPlayerService extends Service implements MediaPlayer.OnCompletionListener,
    ...
    private void initMediaSession() throws RemoteException {
        ...
        mediaSession.setCallback(new MediaSessionCompat.Callback() {
            ...
            public void onPlay() {
                ...
                resumeMedia();
                buildNotification(PlaybackStatus.PLAYING);
                Intent broadcastIntent = new Intent(MainActivity.Broadcast_STATUS);
            ...
            public void onSkipToNext() {
                ...
                buildNotification(PlaybackStatus.PLAYING);
                Intent broadcastIntent = new Intent(MainActivity.Broadcast_STATUS);
                broadcastIntent.putExtra("status",2);
                sendBroadcast(broadcastIntent);
            }
            ...
            public void onStop() {
                ...
                stopSelf();
                Intent broadcastIntent = new Intent(MainActivity.Broadcast_STATUS);
                broadcastIntent.putExtra("status",3);
                sendBroadcast(broadcastIntent);
            }
    ...
    private void buildNotification(PlaybackStatus playbackStatus) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationChannel mChannel = notificationManager.getNotificationChannel("12");
            if (mChannel == null) {
                mChannel = new NotificationChannel("12", "notif", importance);
