...
public class PlayerActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener,SearchResultsAdapter.SearchResultActionListener {
    ...
    @Override
    public void onDownloadAction(String video_id, String title, String thumbnail, String artist) {
