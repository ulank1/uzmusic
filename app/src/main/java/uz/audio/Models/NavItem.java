...
public class NavItem {
    ...
    public static String[] icons = {TRENDING_TEXT,UPDATES_TEXT,ABOUT_TEXT,DOWNLOADS_TEXT};
    public static String[] titles = {"Узбекские песни","Топ - 100","Избранное","Скачанные"};
    public String icon;
    public String title;
