...
public class AnyAudioStreamService extends Service {
    ...
    private void onNextRequested() {
     ...
     /*   if (utils.getAutoPlayMode()) {
        ...
        Shared.position++;
        if (Shared.position==Shared.playlistItems.size()){
            Shared.position = 0;
        }
        nxtItem = Shared.playlistItems.get(Shared.position);
        ...
        Log.e("DuplicateTest", "nextVid:=" + upNextVid + " nextTitle:=" + upNextTitle);
