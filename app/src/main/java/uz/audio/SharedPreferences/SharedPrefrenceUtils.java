package uz.audio.SharedPreferences;
...
import static uz.audio.Centrals.CentralDataRepository.TYPE_TRENDING;
...
public class SharedPrefrenceUtils {
    ...
    public String getTitle() {
        return preferences.getString("titlee","");
    }

    public void setTitle(String index){
        editor.putString("titlee",index);
        editor.commit();
    }
